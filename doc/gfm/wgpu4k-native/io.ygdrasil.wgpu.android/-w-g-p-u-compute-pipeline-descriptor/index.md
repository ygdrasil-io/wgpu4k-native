//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUComputePipelineDescriptor](index.md)

# WGPUComputePipelineDescriptor

sealed class [WGPUComputePipelineDescriptor](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUComputePipelineDescriptor](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUComputePipelineDescriptor](index.md), Structure.ByValue |
...
| [compute](compute.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [compute](compute.md): [WGPUProgrammableStageDescriptor.ByValue](../-w-g-p-u-programmable-stage-descriptor/-by-value/index.md) |
