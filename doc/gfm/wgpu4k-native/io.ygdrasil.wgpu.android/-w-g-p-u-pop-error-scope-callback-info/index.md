//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUPopErrorScopeCallbackInfo](index.md)

# WGPUPopErrorScopeCallbackInfo

sealed class [WGPUPopErrorScopeCallbackInfo](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUPopErrorScopeCallbackInfo](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUPopErrorScopeCallbackInfo](index.md), Structure.ByValue |
