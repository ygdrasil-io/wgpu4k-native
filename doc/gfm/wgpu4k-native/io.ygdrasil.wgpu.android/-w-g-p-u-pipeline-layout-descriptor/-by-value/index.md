//[wgpu4k-native](../../../../index.md)/[io.ygdrasil.wgpu.android](../../index.md)/[WGPUPipelineLayoutDescriptor](../index.md)/[ByValue](index.md)

# ByValue

[android]\
class [ByValue](index.md)(pointer: Pointer? = null) : [WGPUPipelineLayoutDescriptor](../index.md), Structure.ByValue

## Constructors

| | |
|---|---|
| [ByValue](-by-value.md) | [android]<br>constructor(other: [WGPUPipelineLayoutDescriptor](../index.md))constructor(pointer: Pointer? = null) |
