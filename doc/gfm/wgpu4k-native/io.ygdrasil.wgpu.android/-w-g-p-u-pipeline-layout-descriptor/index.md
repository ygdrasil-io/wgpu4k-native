//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUPipelineLayoutDescriptor](index.md)

# WGPUPipelineLayoutDescriptor

sealed class [WGPUPipelineLayoutDescriptor](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUPipelineLayoutDescriptor](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUPipelineLayoutDescriptor](index.md), Structure.ByValue |
...
| [bindGroupLayoutCount](bind-group-layout-count.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [bindGroupLayoutCount](bind-group-layout-count.md): [Long](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-long/index.html) |
| [bindGroupLayouts](bind-group-layouts.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [bindGroupLayouts](bind-group-layouts.md): Pointer? |
