//[wgpu4k-native](../../../../index.md)/[io.ygdrasil.wgpu.android](../../index.md)/[WGPUChainedStructOut](../index.md)/[ByValue](index.md)

# ByValue

[android]\
class [ByValue](index.md)(pointer: Pointer? = null) : [WGPUChainedStructOut](../index.md), Structure.ByValue

## Constructors

| | |
|---|---|
| [ByValue](-by-value.md) | [android]<br>constructor(other: [WGPUChainedStructOut](../index.md))constructor(pointer: Pointer? = null) |
