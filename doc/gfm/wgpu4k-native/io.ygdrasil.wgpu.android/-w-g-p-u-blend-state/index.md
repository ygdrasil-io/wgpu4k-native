//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUBlendState](index.md)

# WGPUBlendState

sealed class [WGPUBlendState](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUBlendState](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUBlendState](index.md), Structure.ByValue |

## Properties

| Name | Summary |
|---|---|
| [alpha](alpha.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [alpha](alpha.md): [WGPUBlendComponent.ByValue](../-w-g-p-u-blend-component/-by-value/index.md) |
...
| [color](color.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [color](color.md): [WGPUBlendComponent.ByValue](../-w-g-p-u-blend-component/-by-value/index.md) |
