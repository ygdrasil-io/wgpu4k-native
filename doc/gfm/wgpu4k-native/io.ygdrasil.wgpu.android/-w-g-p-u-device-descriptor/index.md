//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUDeviceDescriptor](index.md)

# WGPUDeviceDescriptor

sealed class [WGPUDeviceDescriptor](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUDeviceDescriptor](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUDeviceDescriptor](index.md), Structure.ByValue |
...
| [defaultQueue](default-queue.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [defaultQueue](default-queue.md): [WGPUQueueDescriptor.ByValue](../-w-g-p-u-queue-descriptor/-by-value/index.md) |
| [deviceLostCallbackInfo](device-lost-callback-info.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [deviceLostCallbackInfo](device-lost-callback-info.md): [WGPUDeviceLostCallbackInfo.ByValue](../-w-g-p-u-device-lost-callback-info/-by-value/index.md) |
...
| [requiredFeatureCount](required-feature-count.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [requiredFeatureCount](required-feature-count.md): [Long](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-long/index.html) |
| [requiredFeatures](required-features.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [requiredFeatures](required-features.md): Pointer? |
| [requiredLimits](required-limits.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [requiredLimits](required-limits.md): [WGPULimits.ByReference](../-w-g-p-u-limits/-by-reference/index.md)? |
| [uncapturedErrorCallbackInfo](uncaptured-error-callback-info.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [uncapturedErrorCallbackInfo](uncaptured-error-callback-info.md): [WGPUUncapturedErrorCallbackInfo.ByValue](../-w-g-p-u-uncaptured-error-callback-info/-by-value/index.md) |
