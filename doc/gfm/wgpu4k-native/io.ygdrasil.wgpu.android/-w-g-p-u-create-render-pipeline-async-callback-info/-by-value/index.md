//[wgpu4k-native](../../../../index.md)/[io.ygdrasil.wgpu.android](../../index.md)/[WGPUCreateRenderPipelineAsyncCallbackInfo](../index.md)/[ByValue](index.md)

# ByValue

[android]\
class [ByValue](index.md)(pointer: Pointer? = null) : [WGPUCreateRenderPipelineAsyncCallbackInfo](../index.md), Structure.ByValue

## Constructors

| | |
|---|---|
| [ByValue](-by-value.md) | [android]<br>constructor(other: [WGPUCreateRenderPipelineAsyncCallbackInfo](../index.md))constructor(pointer: Pointer? = null) |
