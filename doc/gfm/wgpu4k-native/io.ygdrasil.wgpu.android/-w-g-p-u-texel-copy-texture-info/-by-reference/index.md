//[wgpu4k-native](../../../../index.md)/[io.ygdrasil.wgpu.android](../../index.md)/[WGPUTexelCopyTextureInfo](../index.md)/[ByReference](index.md)

# ByReference

[android]\
class [ByReference](index.md)(pointer: Pointer? = null) : [WGPUTexelCopyTextureInfo](../index.md), Structure.ByReference

## Constructors

| | |
|---|---|
| [ByReference](-by-reference.md) | [android]<br>constructor(other: [WGPUTexelCopyTextureInfo](../index.md))constructor(pointer: Pointer? = null) |
