//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPURenderPipelineDescriptor](index.md)

# WGPURenderPipelineDescriptor

sealed class [WGPURenderPipelineDescriptor](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPURenderPipelineDescriptor](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPURenderPipelineDescriptor](index.md), Structure.ByValue |
...
| [depthStencil](depth-stencil.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [depthStencil](depth-stencil.md): [WGPUDepthStencilState.ByReference](../-w-g-p-u-depth-stencil-state/-by-reference/index.md)? |
| [fragment](fragment.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [fragment](fragment.md): [WGPUFragmentState.ByReference](../-w-g-p-u-fragment-state/-by-reference/index.md)? |
...
| [layout](layout.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [layout](layout.md): Pointer? |
| [multisample](multisample.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [multisample](multisample.md): [WGPUMultisampleState.ByValue](../-w-g-p-u-multisample-state/-by-value/index.md) |
...
| [primitive](primitive.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [primitive](primitive.md): [WGPUPrimitiveState.ByValue](../-w-g-p-u-primitive-state/-by-value/index.md) |
| [vertex](vertex.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [vertex](vertex.md): [WGPUVertexState.ByValue](../-w-g-p-u-vertex-state/-by-value/index.md) |
