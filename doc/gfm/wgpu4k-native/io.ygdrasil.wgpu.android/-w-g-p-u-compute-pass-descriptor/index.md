//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUComputePassDescriptor](index.md)

# WGPUComputePassDescriptor

sealed class [WGPUComputePassDescriptor](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUComputePassDescriptor](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUComputePassDescriptor](index.md), Structure.ByValue |
...
| [timestampWrites](timestamp-writes.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [timestampWrites](timestamp-writes.md): [WGPUComputePassTimestampWrites.ByReference](../-w-g-p-u-compute-pass-timestamp-writes/-by-reference/index.md)? |
