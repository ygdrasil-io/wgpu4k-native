//[wgpu4k-native](../../../../index.md)/[io.ygdrasil.wgpu.android](../../index.md)/[WGPUQueueWorkDoneCallbackInfo](../index.md)/[ByValue](index.md)

# ByValue

[android]\
class [ByValue](index.md)(pointer: Pointer? = null) : [WGPUQueueWorkDoneCallbackInfo](../index.md), Structure.ByValue

## Constructors

| | |
|---|---|
| [ByValue](-by-value.md) | [android]<br>constructor(other: [WGPUQueueWorkDoneCallbackInfo](../index.md))constructor(pointer: Pointer? = null) |
