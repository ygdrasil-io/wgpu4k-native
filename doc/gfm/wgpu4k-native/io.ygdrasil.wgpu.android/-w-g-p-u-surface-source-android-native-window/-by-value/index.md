//[wgpu4k-native](../../../../index.md)/[io.ygdrasil.wgpu.android](../../index.md)/[WGPUSurfaceSourceAndroidNativeWindow](../index.md)/[ByValue](index.md)

# ByValue

[android]\
class [ByValue](index.md)(pointer: Pointer? = null) : [WGPUSurfaceSourceAndroidNativeWindow](../index.md), Structure.ByValue

## Constructors

| | |
|---|---|
| [ByValue](-by-value.md) | [android]<br>constructor(other: [WGPUSurfaceSourceAndroidNativeWindow](../index.md))constructor(pointer: Pointer? = null) |
