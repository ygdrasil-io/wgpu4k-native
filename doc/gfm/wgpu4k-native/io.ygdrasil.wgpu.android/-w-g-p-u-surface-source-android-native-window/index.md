//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUSurfaceSourceAndroidNativeWindow](index.md)

# WGPUSurfaceSourceAndroidNativeWindow

sealed class [WGPUSurfaceSourceAndroidNativeWindow](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUSurfaceSourceAndroidNativeWindow](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUSurfaceSourceAndroidNativeWindow](index.md), Structure.ByValue |
...
| [window](window.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [window](window.md): Pointer? |
