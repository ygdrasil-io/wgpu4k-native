//[wgpu4k-native](../../../../index.md)/[io.ygdrasil.wgpu.android](../../index.md)/[WGPUVertexAttribute](../index.md)/[ByValue](index.md)

# ByValue

[android]\
class [ByValue](index.md)(pointer: Pointer? = null) : [WGPUVertexAttribute](../index.md), Structure.ByValue

## Constructors

| | |
|---|---|
| [ByValue](-by-value.md) | [android]<br>constructor(other: [WGPUVertexAttribute](../index.md))constructor(pointer: Pointer? = null) |
