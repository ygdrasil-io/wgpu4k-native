//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUSurfaceSourceXCBWindow](index.md)

# WGPUSurfaceSourceXCBWindow

sealed class [WGPUSurfaceSourceXCBWindow](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUSurfaceSourceXCBWindow](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUSurfaceSourceXCBWindow](index.md), Structure.ByValue |
...
| [connection](connection.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [connection](connection.md): Pointer? |
| [window](window.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [window](window.md): [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html) |
