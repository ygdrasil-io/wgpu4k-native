//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUShaderSourceWGSL](index.md)

# WGPUShaderSourceWGSL

sealed class [WGPUShaderSourceWGSL](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUShaderSourceWGSL](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUShaderSourceWGSL](index.md), Structure.ByValue |
...
| [code](code.md) | [android]<br>@[JvmField](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html)<br>var [code](code.md): [WGPUStringView.ByValue](../-w-g-p-u-string-view/-by-value/index.md) |
