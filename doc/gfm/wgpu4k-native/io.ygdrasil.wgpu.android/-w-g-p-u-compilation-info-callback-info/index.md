//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu.android](../index.md)/[WGPUCompilationInfoCallbackInfo](index.md)

# WGPUCompilationInfoCallbackInfo

sealed class [WGPUCompilationInfoCallbackInfo](index.md) : Structure
...
| Name | Summary |
|---|---|
| [ByReference](-by-reference/index.md) | [android]<br>class [ByReference](-by-reference/index.md)(pointer: Pointer? = null) : [WGPUCompilationInfoCallbackInfo](index.md), Structure.ByReference |
| [ByValue](-by-value/index.md) | [android]<br>class [ByValue](-by-value/index.md)(pointer: Pointer? = null) : [WGPUCompilationInfoCallbackInfo](index.md), Structure.ByValue |
