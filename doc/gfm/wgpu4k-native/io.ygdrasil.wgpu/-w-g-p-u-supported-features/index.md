//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu](../index.md)/[WGPUSupportedFeatures](index.md)

# WGPUSupportedFeatures

expect interface [WGPUSupportedFeatures](index.md)actual interface [WGPUSupportedFeatures](index.md)actual interface [WGPUSupportedFeatures](index.md) : [CStructure](../../ffi/[jvm]-c-structure/index.md)actual interface [WGPUSupportedFeatures](index.md)
...
| Name | Summary |
|---|---|
| ByReference | [android, jvm, native]<br>[android]<br>class [ByReference]([android]-by-reference/index.md)(val handle: WGPUSupportedFeatures.ByReference = io.ygdrasil.wgpu.android.WGPUSupportedFeatures.ByReference(com.sun.jna.Pointer.NULL)) : [WGPUSupportedFeatures](index.md)<br>[jvm]<br>@[JvmInline](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-inline/index.html)<br>value class [ByReference]([jvm]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUSupportedFeatures](index.md)<br>[native]<br>value class [ByReference]([native]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUSupportedFeatures](index.md) |
| ByValue | [android, native]<br>[android]<br>class [ByValue]([android]-by-value/index.md)(val handle: WGPUSupportedFeatures.ByValue = io.ygdrasil.wgpu.android.WGPUSupportedFeatures.ByValue(com.sun.jna.Pointer.NULL)) : [WGPUSupportedFeatures](index.md)<br>[native]<br>value class [ByValue]([native]-by-value/index.md)(val handle: [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUSupportedFeatures&gt;) : [WGPUSupportedFeatures](index.md) |
...
| [features](features.md) | [common, android, jvm, native]<br>[common]<br>expect abstract var [features](features.md): [ArrayHolder](../../ffi/-array-holder/index.md)&lt;[WGPUFeatureName](../-w-g-p-u-feature-name/index.md)&gt;?<br>[android, jvm, native]<br>actual abstract var [features](features.md): [ArrayHolder](../../ffi/-array-holder/index.md)&lt;[WGPUFeatureName](../-w-g-p-u-feature-name/index.md)&gt;? |
...
| toCValue | [android, native]<br>[android]<br>open fun [toCValue]([android]to-c-value.md)(): WGPUSupportedFeatures.ByValue<br>[native]<br>open fun [toCValue]([native]to-c-value.md)(): [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUSupportedFeatures&gt; |
