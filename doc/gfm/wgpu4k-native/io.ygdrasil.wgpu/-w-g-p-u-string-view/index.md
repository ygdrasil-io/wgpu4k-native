//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu](../index.md)/[WGPUStringView](index.md)

# WGPUStringView

expect interface [WGPUStringView](index.md)actual interface [WGPUStringView](index.md)actual interface [WGPUStringView](index.md) : [CStructure](../../ffi/[jvm]-c-structure/index.md)actual interface [WGPUStringView](index.md)
...
| Name | Summary |
|---|---|
| ByReference | [android, jvm, native]<br>[android]<br>class [ByReference]([android]-by-reference/index.md)(val handle: [WGPUStringView.ByReference](../../io.ygdrasil.wgpu.android/-w-g-p-u-string-view/-by-reference/index.md) = io.ygdrasil.wgpu.android.WGPUStringView.ByReference(com.sun.jna.Pointer.NULL)) : [WGPUStringView](index.md)<br>[jvm]<br>@[JvmInline](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-inline/index.html)<br>value class [ByReference]([jvm]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUStringView](index.md)<br>[native]<br>value class [ByReference]([native]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUStringView](index.md) |
| ByValue | [android, native]<br>[android]<br>class [ByValue]([android]-by-value/index.md)(val handle: [WGPUStringView.ByValue](../../io.ygdrasil.wgpu.android/-w-g-p-u-string-view/-by-value/index.md) = io.ygdrasil.wgpu.android.WGPUStringView.ByValue(com.sun.jna.Pointer.NULL)) : [WGPUStringView](index.md)<br>[native]<br>value class [ByValue]([native]-by-value/index.md)(val handle: [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUStringView&gt;) : [WGPUStringView](index.md) |
...
| Name | Summary |
|---|---|
| [data](data.md) | [common, android, jvm, native]<br>[common]<br>expect abstract var [data](data.md): [CString](../../ffi/-c-string/index.md)?<br>[android, jvm, native]<br>actual abstract var [data](data.md): [CString](../../ffi/-c-string/index.md)? |
...
| [length](length.md) | [common, android, jvm, native]<br>[common]<br>expect abstract var [length](length.md): [ULong](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-u-long/index.html)<br>[android, jvm, native]<br>actual abstract var [length](length.md): [ULong](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-u-long/index.html) |
...
| toCValue | [android, native]<br>[android]<br>open fun [toCValue]([android]to-c-value.md)(): [WGPUStringView.ByValue](../../io.ygdrasil.wgpu.android/-w-g-p-u-string-view/-by-value/index.md)<br>[native]<br>open fun [toCValue]([native]to-c-value.md)(): [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUStringView&gt; |
