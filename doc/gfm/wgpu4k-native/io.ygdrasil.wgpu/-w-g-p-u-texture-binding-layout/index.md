//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu](../index.md)/[WGPUTextureBindingLayout](index.md)

# WGPUTextureBindingLayout

expect interface [WGPUTextureBindingLayout](index.md)actual interface [WGPUTextureBindingLayout](index.md)actual interface [WGPUTextureBindingLayout](index.md) : [CStructure](../../ffi/[jvm]-c-structure/index.md)actual interface [WGPUTextureBindingLayout](index.md)
...
| Name | Summary |
|---|---|
| ByReference | [android, jvm, native]<br>[android]<br>class [ByReference]([android]-by-reference/index.md)(val handle: WGPUTextureBindingLayout.ByReference = io.ygdrasil.wgpu.android.WGPUTextureBindingLayout.ByReference(com.sun.jna.Pointer.NULL)) : [WGPUTextureBindingLayout](index.md)<br>[jvm]<br>@[JvmInline](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-inline/index.html)<br>value class [ByReference]([jvm]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUTextureBindingLayout](index.md)<br>[native]<br>value class [ByReference]([native]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUTextureBindingLayout](index.md) |
| ByValue | [android, native]<br>[android]<br>class [ByValue]([android]-by-value/index.md)(val handle: WGPUTextureBindingLayout.ByValue = io.ygdrasil.wgpu.android.WGPUTextureBindingLayout.ByValue(com.sun.jna.Pointer.NULL)) : [WGPUTextureBindingLayout](index.md)<br>[native]<br>value class [ByValue]([native]-by-value/index.md)(val handle: [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUTextureBindingLayout&gt;) : [WGPUTextureBindingLayout](index.md) |
...
| [multisampled](multisampled.md) | [common, android, jvm, native]<br>[common]<br>expect abstract var [multisampled](multisampled.md): [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html)<br>[android, jvm, native]<br>actual abstract var [multisampled](multisampled.md): [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) |
...
| [sampleType](sample-type.md) | [common, android, jvm, native]<br>[common]<br>expect abstract var [sampleType](sample-type.md): [WGPUTextureSampleType](../-w-g-p-u-texture-sample-type/index.md)<br>[android, jvm, native]<br>actual abstract var [sampleType](sample-type.md): [WGPUTextureSampleType](../-w-g-p-u-texture-sample-type/index.md) |
| [viewDimension](view-dimension.md) | [common, android, jvm, native]<br>[common]<br>expect abstract var [viewDimension](view-dimension.md): [WGPUTextureViewDimension](../-w-g-p-u-texture-view-dimension/index.md)<br>[android, jvm, native]<br>actual abstract var [viewDimension](view-dimension.md): [WGPUTextureViewDimension](../-w-g-p-u-texture-view-dimension/index.md) |
...
| toCValue | [android, native]<br>[android]<br>open fun [toCValue]([android]to-c-value.md)(): WGPUTextureBindingLayout.ByValue<br>[native]<br>open fun [toCValue]([native]to-c-value.md)(): [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUTextureBindingLayout&gt; |
