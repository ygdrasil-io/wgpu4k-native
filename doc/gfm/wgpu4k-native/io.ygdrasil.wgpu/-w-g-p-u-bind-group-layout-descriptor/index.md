//[wgpu4k-native](../../../index.md)/[io.ygdrasil.wgpu](../index.md)/[WGPUBindGroupLayoutDescriptor](index.md)

# WGPUBindGroupLayoutDescriptor

expect interface [WGPUBindGroupLayoutDescriptor](index.md)actual interface [WGPUBindGroupLayoutDescriptor](index.md)actual interface [WGPUBindGroupLayoutDescriptor](index.md) : [CStructure](../../ffi/[jvm]-c-structure/index.md)actual interface [WGPUBindGroupLayoutDescriptor](index.md)
...
| Name | Summary |
|---|---|
| ByReference | [android, jvm, native]<br>[android]<br>class [ByReference]([android]-by-reference/index.md)(val handle: WGPUBindGroupLayoutDescriptor.ByReference = io.ygdrasil.wgpu.android.WGPUBindGroupLayoutDescriptor.ByReference(com.sun.jna.Pointer.NULL)) : [WGPUBindGroupLayoutDescriptor](index.md)<br>[jvm]<br>@[JvmInline](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-inline/index.html)<br>value class [ByReference]([jvm]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUBindGroupLayoutDescriptor](index.md)<br>[native]<br>value class [ByReference]([native]-by-reference/index.md)(val handler: [NativeAddress](../../ffi/-native-address/index.md)) : [WGPUBindGroupLayoutDescriptor](index.md) |
| ByValue | [android, native]<br>[android]<br>class [ByValue]([android]-by-value/index.md)(val handle: WGPUBindGroupLayoutDescriptor.ByValue = io.ygdrasil.wgpu.android.WGPUBindGroupLayoutDescriptor.ByValue(com.sun.jna.Pointer.NULL)) : [WGPUBindGroupLayoutDescriptor](index.md)<br>[native]<br>value class [ByValue]([native]-by-value/index.md)(val handle: [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUBindGroupLayoutDescriptor&gt;) : [WGPUBindGroupLayoutDescriptor](index.md) |
...
| Name | Summary |
|---|---|
| [entries](entries.md) | [common, android, jvm, native]<br>[common]<br>expect abstract var [entries](entries.md): [ArrayHolder](../../ffi/-array-holder/index.md)&lt;[WGPUBindGroupLayoutEntry](../-w-g-p-u-bind-group-layout-entry/index.md)&gt;?<br>[android, jvm, native]<br>actual abstract var [entries](entries.md): [ArrayHolder](../../ffi/-array-holder/index.md)&lt;[WGPUBindGroupLayoutEntry](../-w-g-p-u-bind-group-layout-entry/index.md)&gt;? |
...
| toCValue | [android, native]<br>[android]<br>open fun [toCValue]([android]to-c-value.md)(): WGPUBindGroupLayoutDescriptor.ByValue<br>[native]<br>open fun [toCValue]([native]to-c-value.md)(): [CValue](https://kotlinlang.org/api/core/kotlin-stdlib/kotlinx.cinterop/-c-value/index.html)&lt;WGPUBindGroupLayoutDescriptor&gt; |
