...
const val WGPUCallbackMode_WaitAnyOnly : WGPUCallbackMode = 0u
const val WGPUCallbackMode_AllowProcessEvents : WGPUCallbackMode = 1u
const val WGPUCallbackMode_AllowSpontaneous : WGPUCallbackMode = 2u
...
const val WGPUCompilationInfoRequestStatus_InstanceDropped : WGPUCompilationInfoRequestStatus = 1u
...
const val WGPUCreatePipelineAsyncStatus_InstanceDropped : WGPUCreatePipelineAsyncStatus = 1u
...
const val WGPUCreatePipelineAsyncStatus_Unknown : WGPUCreatePipelineAsyncStatus = 4u
...
const val WGPUDeviceLostReason_Unknown : WGPUDeviceLostReason = 0u
const val WGPUDeviceLostReason_Destroyed : WGPUDeviceLostReason = 1u
const val WGPUDeviceLostReason_InstanceDropped : WGPUDeviceLostReason = 2u
const val WGPUDeviceLostReason_FailedCreation : WGPUDeviceLostReason = 3u
...
const val WGPUFeatureLevel_Compatibility : WGPUFeatureLevel = 0u
const val WGPUFeatureLevel_Core : WGPUFeatureLevel = 1u
...
const val WGPUMapAsyncStatus_Success : WGPUMapAsyncStatus = 0u
const val WGPUMapAsyncStatus_InstanceDropped : WGPUMapAsyncStatus = 1u
const val WGPUMapAsyncStatus_Error : WGPUMapAsyncStatus = 2u
const val WGPUMapAsyncStatus_Aborted : WGPUMapAsyncStatus = 3u
const val WGPUMapAsyncStatus_Unknown : WGPUMapAsyncStatus = 4u
...
const val WGPUPopErrorScopeStatus_Success : WGPUPopErrorScopeStatus = 0u
const val WGPUPopErrorScopeStatus_InstanceDropped : WGPUPopErrorScopeStatus = 1u
const val WGPUPopErrorScopeStatus_EmptyStack : WGPUPopErrorScopeStatus = 2u
...
const val WGPUQueueWorkDoneStatus_InstanceDropped : WGPUQueueWorkDoneStatus = 1u
...
const val WGPURequestAdapterStatus_InstanceDropped : WGPURequestAdapterStatus = 1u
...
const val WGPURequestDeviceStatus_InstanceDropped : WGPURequestDeviceStatus = 1u
...
const val WGPUSType_ShaderSourceSPIRV : WGPUSType = 0u
const val WGPUSType_ShaderSourceWGSL : WGPUSType = 1u
const val WGPUSType_RenderPassMaxDrawCount : WGPUSType = 2u
const val WGPUSType_SurfaceSourceMetalLayer : WGPUSType = 3u
const val WGPUSType_SurfaceSourceWindowsHWND : WGPUSType = 4u
const val WGPUSType_SurfaceSourceXlibWindow : WGPUSType = 5u
const val WGPUSType_SurfaceSourceWaylandSurface : WGPUSType = 6u
const val WGPUSType_SurfaceSourceAndroidNativeWindow : WGPUSType = 7u
const val WGPUSType_SurfaceSourceXCBWindow : WGPUSType = 8u
...
const val WGPUSurfaceGetCurrentTextureStatus_Error : WGPUSurfaceGetCurrentTextureStatus = 7u
...
const val WGPUVertexFormat_Uint8 : WGPUVertexFormat = 0u
const val WGPUVertexFormat_Uint8x2 : WGPUVertexFormat = 1u
const val WGPUVertexFormat_Uint8x4 : WGPUVertexFormat = 2u
const val WGPUVertexFormat_Sint8 : WGPUVertexFormat = 3u
const val WGPUVertexFormat_Sint8x2 : WGPUVertexFormat = 4u
const val WGPUVertexFormat_Sint8x4 : WGPUVertexFormat = 5u
const val WGPUVertexFormat_Unorm8 : WGPUVertexFormat = 6u
const val WGPUVertexFormat_Unorm8x2 : WGPUVertexFormat = 7u
const val WGPUVertexFormat_Unorm8x4 : WGPUVertexFormat = 8u
const val WGPUVertexFormat_Snorm8 : WGPUVertexFormat = 9u
const val WGPUVertexFormat_Snorm8x2 : WGPUVertexFormat = 10u
const val WGPUVertexFormat_Snorm8x4 : WGPUVertexFormat = 11u
const val WGPUVertexFormat_Uint16 : WGPUVertexFormat = 12u
const val WGPUVertexFormat_Uint16x2 : WGPUVertexFormat = 13u
const val WGPUVertexFormat_Uint16x4 : WGPUVertexFormat = 14u
const val WGPUVertexFormat_Sint16 : WGPUVertexFormat = 15u
const val WGPUVertexFormat_Sint16x2 : WGPUVertexFormat = 16u
const val WGPUVertexFormat_Sint16x4 : WGPUVertexFormat = 17u
const val WGPUVertexFormat_Unorm16 : WGPUVertexFormat = 18u
const val WGPUVertexFormat_Unorm16x2 : WGPUVertexFormat = 19u
const val WGPUVertexFormat_Unorm16x4 : WGPUVertexFormat = 20u
const val WGPUVertexFormat_Snorm16 : WGPUVertexFormat = 21u
const val WGPUVertexFormat_Snorm16x2 : WGPUVertexFormat = 22u
const val WGPUVertexFormat_Snorm16x4 : WGPUVertexFormat = 23u
const val WGPUVertexFormat_Float16 : WGPUVertexFormat = 24u
const val WGPUVertexFormat_Float16x2 : WGPUVertexFormat = 25u
const val WGPUVertexFormat_Float16x4 : WGPUVertexFormat = 26u
const val WGPUVertexFormat_Float32 : WGPUVertexFormat = 27u
const val WGPUVertexFormat_Float32x2 : WGPUVertexFormat = 28u
const val WGPUVertexFormat_Float32x3 : WGPUVertexFormat = 29u
const val WGPUVertexFormat_Float32x4 : WGPUVertexFormat = 30u
const val WGPUVertexFormat_Uint32 : WGPUVertexFormat = 31u
const val WGPUVertexFormat_Uint32x2 : WGPUVertexFormat = 32u
const val WGPUVertexFormat_Uint32x3 : WGPUVertexFormat = 33u
const val WGPUVertexFormat_Uint32x4 : WGPUVertexFormat = 34u
const val WGPUVertexFormat_Sint32 : WGPUVertexFormat = 35u
const val WGPUVertexFormat_Sint32x2 : WGPUVertexFormat = 36u
const val WGPUVertexFormat_Sint32x3 : WGPUVertexFormat = 37u
const val WGPUVertexFormat_Sint32x4 : WGPUVertexFormat = 38u
const val WGPUVertexFormat_Unorm1010102 : WGPUVertexFormat = 39u
const val WGPUVertexFormat_Unorm8x4BGRA : WGPUVertexFormat = 40u
...
const val WGPUWGSLLanguageFeatureName_ReadonlyAndReadwriteStorageTextures : WGPUWGSLLanguageFeatureName = 0u
const val WGPUWGSLLanguageFeatureName_Packed4x8IntegerDotProduct : WGPUWGSLLanguageFeatureName = 1u
const val WGPUWGSLLanguageFeatureName_UnrestrictedPointerParameters : WGPUWGSLLanguageFeatureName = 2u
const val WGPUWGSLLanguageFeatureName_PointerCompositeAccess : WGPUWGSLLanguageFeatureName = 3u
...
const val WGPUNativeSType_DeviceExtras : WGPUNativeSType = 0u
const val WGPUNativeSType_RequiredLimitsExtras : WGPUNativeSType = 1u
const val WGPUNativeSType_PipelineLayoutExtras : WGPUNativeSType = 2u
const val WGPUNativeSType_ShaderModuleGLSLDescriptor : WGPUNativeSType = 3u
const val WGPUNativeSType_SupportedLimitsExtras : WGPUNativeSType = 4u
const val WGPUNativeSType_InstanceExtras : WGPUNativeSType = 5u
const val WGPUNativeSType_BindGroupEntryExtras : WGPUNativeSType = 6u
const val WGPUNativeSType_BindGroupLayoutEntryExtras : WGPUNativeSType = 7u
const val WGPUNativeSType_QuerySetDescriptorExtras : WGPUNativeSType = 8u
const val WGPUNativeSType_SurfaceConfigurationExtras : WGPUNativeSType = 9u
